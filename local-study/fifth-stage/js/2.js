...
// 几何体 - 平面长方形
const boxGeometry = new THREE.PlaneGeometry(100, 50);
...
console.log("uv", boxGeometry.attributes.position);
/**纹理坐标0~1之间随意定义*/
...
boxGeometry.attributes.uv = new THREE.BufferAttribute(uvs, 2); //2个为一组,表示一个顶点的纹理坐标
